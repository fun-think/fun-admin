...
- AdminMenu icon #53 ([#53](https://github.com/antdv-pro/antdv-pro/issues/53))
...
- AdminMenu hidden header is not full close #71 ([#71](https://github.com/antdv-pro/antdv-pro/issues/71))
...
### 🚀 Enhancements
  ...
  - Add locale (7adbce1)
  - AdminMenu support i18n (74baf00)
  - Title support title (aea9fd9)

### 🩹 Fixes

  - Fix split menu change error (da34522)
  - AdminMenu title error (a13462e)
  - AdminMenu title error (5a70263)
